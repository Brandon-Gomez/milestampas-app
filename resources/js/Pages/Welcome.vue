...
// modules
const modules = [Pagination, Navigation, Scrollbar, EffectFade, Autoplay];
const navigation = {
    categories: [
        {
            id: 'national',
...
const photosExamples = [
    "https://www.futbolemotion.com/imagesbanners/xxl/liquidacion_rebajas0724_ES.webp",
    "https://www.futbolemotion.com/imagesbanners/xxl/1721739168nike_fcbarcelona_home24_v2_OK.webp",
    "https://www.futbolemotion.com/imagesbanners/xxl/1721739168nike_fcbarcelona_home24_v2_OK.webp",
    "https://www.futbolemotion.com/imagesbanners/xxl/adidas_realmadrid_away24.webp"
]

const products = [
    {
        id: 1,
        name: '2000-01 Nike Rain Jacket - 9 / 10',
        href: '#',
        price: '$48.00',
        imageSrc: 'QVJC7BHFY3KwMmfpDJ0PT21k0lLM91WaX9FSwLt7.jpg',
...
// premier league teams (names,logo,link)
const premierLeague = [
    {
        name: 'Arsenal',
        logo: 'arsenal.png',
...
<template>
                        ...
                        <DialogPanel
                            ...
                            <div class="px-4 py-6 space-y-6 border-t border-gray-200">
                                <div v-for="page in navigation.pages" :key="page.name" class="flow-root">
                                    <a :href="page.href" class="block p-2 -m-2 font-medium text-gray-900">{{ page.name
                                        }}</a>
                                </div>
                            </div>
                ...
                <div class="flex items-center h-16">
                    ...
                    <div class="flex items-center ml-auto">
                        ...
                        <div class="flow-root ml-4 lg:ml-6">
                            ...
                            <button type="button" class="text-center btn btn-link text-secondary text-decoration-none">
    ...
    <!-- Banners -->
    <Swiper :modules="modules" :navigation="true" :scrollbar="true" :autoplay="true" effect="fade">
        <SwiperSlide v-for="photo in photosExamples">
            <img :src="photo" alt="photo" class="object-cover w-full select-none" />
        </SwiperSlide>
    </Swiper>

    <Swiper :modules="modules" :autoplay="true" effect="fade">
        <SwiperSlide>
            <div
                class="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
                <a href="#" class="flex items-center text-sm font-semibold leading-6 text-gray-900 gap-x-2 gap-y-2">
                    <i class="pi pi-instagram">
                    </i>
                    <strong class="underline ">
                        Instagram</strong><svg viewBox="0 0 2 2" class=" inline h-0.5 w-0.5 fill-current"
                        aria-hidden="true">
        ...
        <SwiperSlide>
            <div
                class="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
                <a href="#" class="flex items-center text-sm font-extrabold leading-6 text-gray-900 gap-x-2 gap-y-2">
                    <i class="pi pi-tiktok">
                    </i>
                    <strong class="underline ">
                        Tiktok</strong><svg viewBox="0 0 2 2" class=" inline h-0.5 w-0.5 fill-current"
                        aria-hidden="true">
                        <circle cx="1" cy="1" r="1" />
                    </svg>
                    10k Followers
    ...
    <section class="px-4 mx-auto sm:px-6 lg:px-8 max-w-[107rem] mt-12 ">
        <div>
            <p class="mx-auto text-3xl font-semibold mb-7">New in 2024-25
            </p>
        </div>
        <div>
                        ...
                        <div class="mb-4">
                            <div class="relative mx-auto">
                                <a :href="'/products/' + slotProps.data.id">
                                    <img :src="'/storage/products/' + slotProps.data.image" :alt="slotProps.data.name"
                                        class="w-full select-none max-w-60" />
    ...
    <!-- section banner  -->
    <section class="px-4 mx-auto lg:px-8 max-w-[107rem] my-12">
        <div class="relative hidden py-24 overflow-hidden isolate lg:block">
            <img src="https://imagedelivery.net/8UvgnujKc71BuSRDtL99OQ/4539fc8b-4e66-458a-b127-1ef145e1af00/2048x1152"
                alt="" class="absolute inset-0 object-cover object-right w-full h-full -z-10 ">
            <div class="mr-10 text-right">
                <h2 class="text-6xl font-bold tracking-tight text-white drop-shadow-xl">Adidas <br>Retro Collection
                </h2>
                <a href="#" class="mt-6 text-xl leading-8 text-gray-300 underline">Buy now <span>&rarr;</span></a>
            </div>
        </div>
        <!-- Display mobile -->
        <div class="relative flex justify-center py-[12rem] overflow-hidden isolate lg:hidden">
            <img src="https://imagedelivery.net/8UvgnujKc71BuSRDtL99OQ/86e5dcca-c3e4-421a-6986-7b3d0cac5b00/mobilebanner"
                alt="" class="absolute inset-0 object-cover object-right w-full h-full -z-10 ">
            <div class="absolute text-center bottom-3">
                <p class="text-xl font-bold tracking-tight text-white drop-shadow-xl">
                    Adidas Retro Collection
                </p>
                <a href="#" class="text-lg leading-8 text-gray-300 underline ">Buy now <span>&rarr;</span></a>
            </div>
        </div>
    </section>
    ...
    <section class="px-4 mx-auto sm:px-6 lg:px-8 max-w-[107rem] mt-12 ">
        <div class="flex flex-col items-center ">
            <p class="text-3xl font-semibold mb-7">Shop By Team</p>
            <Tabs value="0" scrollable>
                <TabList>
                    <Tab value="0"> Premier League </Tab>
                    <Tab value="1">French Ligue 1
                    </Tab>
                    <Tab value="2">German Budesliga</Tab>
                    <Tab value="3">Italian Serie A</Tab>
                    <Tab value="4">Spanish La Liga</Tab>
                    <Tab value="5">International</Tab>
                </TabList>
                <TabPanels>
                    <TabPanel value="0">
                        <Carousel :value="premierLeague" :numVisible="4" :numScroll="1"
                            :responsiveOptions="responsiveOptions" :showIndicators="false">
                            <template #item="slotProps">
                                <div class="mx-1 border rounded border-surface-200 dark:border-surface-700 bg-gray-50">
                                    <div class="flex flex-col">
                                        <div class="inline-flex items-center justify-center mx-auto">
                                            <img :src="'/storage/products/' + slotProps.data.logo"
                                                :alt="slotProps.data.name" class="w-20 mt-8 mb-4 select-none " />
                                        </div>
                                        <p class="inline-flex items-center justify-center mx-auto mb-5">{{
                                            slotProps.data.name }}
                                        </p>
                    ...
                    <TabPanel value="1">
                        <Carousel :value="ligue1" :numVisible="4" :numScroll="1" :responsiveOptions="responsiveOptions"
                            :showIndicators="false">
                            <template #item="slotProps">
                                <div class="mx-1 border rounded border-surface-200 dark:border-surface-700 bg-gray-50">
                                    <div class="flex flex-col">
    ...
    <div class="py-5 bg-red-700">
        ...
        <div class="flex overflow-hidden ">
            <div class="break-keep">Free Shipping Order Over £250</div>
            <div>Great Discounts</div>
            <div>Secure Shopping</div>
            <div>Create a Club Shop</div>
        </div>
