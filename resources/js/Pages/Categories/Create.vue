...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">Categorys</h2>
        </template>
                                ...
                                <div class="flex">
                                    ...
                                    <div class="w-1/2 p-4">
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-6 sm:col-span-6">
                                                <label class="block text-sm font-medium text-gray-700">Parent
                                                    Category</label>
                    ...
                    <!-- <Tabs value="1">
                            ...
                            <TabPanels>
                                ...
                                <TabPanel>
                                    ...
                                    <Select v-model="form.parent_category_id" :options="categories.data" optionValue="id"
